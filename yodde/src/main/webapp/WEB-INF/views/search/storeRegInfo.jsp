      ...
      <div class="storeRegInfo_content">
         ...
         <ul>
            ...
            <li>
               ...
               <textarea cols="60" class="reg_address" id="context" name="address" style="resize:none;"></textarea>
            </li>      
            
            <li class="bottom_Btn">
               <button type="submit" style="height:25px; width:75px; border:none; background-image: url(${root}/resources/images/images/ok.png); background-size: 100%;" onclick="alert('요청해주셔서 감사합니다.');window.close()"></button>

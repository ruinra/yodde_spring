         ...
         <div class="storeInfo_content">
               ...
               <ul class="storeInfo_ul">
                  <li class="storeInfo_box">
                     <div class="starrate">
                        ...
                        <%-- 
                        <img src="${root}/resources/images/images/starrate_ex.png"height="35" style="margin-left: 30px;">
                         --%>
                         <span id="averageRate" class="input"></span>
   
                     <script>
                              $.fn.raty.defaults.path = '${root}/resources/images/img';
                              $('#averageRate').raty({
                     ...
                     <div style="position: absolute;">
                        ...
                        <!-- 스토어 위치 -->
                        <div class="map">
                           <div id="scholes" style="border: 2px solid #DCDCDF; width: 490px; height: 200px; margin: 5px;"></div>
                        </div>
                  ...
                  <li class="store_icon">
                     <!-- 스토어 info --> <img
                     src="${root}/resources/images/images_store_info/card.png" width="55" style="margin-right: 10px;"> <img
                     src="${root}/resources/images/images_store_info/group.png" width="55" style="margin-right: 10px;"> <img
                     src="${root}/resources/images/images_store_info/toilet.png" width="45" style="margin-right: 10px;"> <img
                     src="${root}/resources/images/images_store_info/wifi.png" width="50" style="margin-right: 10px;"> <img
                     src="${root}/resources/images/images_store_info/parking.png" width="55" style="margin-right: 10px;"> <img
                     src="${root}/resources/images/images_store_info/reservation.png" width="45" style="margin-right: 10px;">
                  </li>
               </ul>
            </div>
            ...
            <div class="write_box">
               ...
               <div class="review_title">
                  ...
                  <div class="write_btn">
                     <a href="javascript:showReviewEditor('${email}')"> <img src="${root}/resources/images/images/write.png" height="25"> </a>
                  </div>
               </div>
               ...
               <div id="reviewEditorDiv" style="display: none;" class="review_write">
                  <form action="writeReivew" method="post" enctype="multipart/form-data">
                     ...
                     <input align="right" type="IMAGE" class="review_write" src="${root}/resources/images/images/ok.png" height="30" name="Submit" value="Submit">
                  </form>
               </div>
               <br /> <br />
               ...
               <div class="review_board">
                  <!-- 리뷰 보드 -->
                  <c:forEach begin="0" varStatus="status" end ="${fn:length(reviewList)}" var="itemReview" items="${reviewList}">
                     <div class="review">
                        <!-- DB에서 리뷰 받아와서 뿌려줌 -->
                        <span class="reviewer_profile">
                           <span class="review_content"> <!-- 리뷰어 내용 -->
                              ...
                              <span class="content_btn"> <!-- 본인 댓글이면 수정, 타인 댓글이면 신고 -->
                                 <span class="btn_position"><a href=""><img src="${root}/resources/images/images/update.png" height="25"></a>
                              </span>

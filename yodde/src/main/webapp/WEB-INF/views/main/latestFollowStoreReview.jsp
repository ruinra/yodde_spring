...
<!--       <link rel="stylesheet" type="text/css" href="manyLikes.css"/> -->
   </head>
   <body style="min-width:1260px;">
      ...
      <div class="content">                           <!-- content -->
         <div class="HR_content">					
            <div class="HR_box">
               <div class="HR_title">					<!-- latestFollowStoreReview title -->
                  <img src="./../images/hotnow.png" height="40px;"/>		<!-- image change -->

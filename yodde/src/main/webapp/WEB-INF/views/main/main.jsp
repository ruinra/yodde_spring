			...
			<div class="main_content">
				<div class="store_box">
					<div class="store_box_title">
						<img src="${root}/resources/images/images/1_HOT.png" height="55">
					</div>
					<div class="stores">
				...
				<div class="store_box">
					<div class="store_box_title">
						<img src="${root}/resources/images/images/2_REGION.png" height="55">
					</div>
					<div class="stores">
						접속 지역 기준 스토어 추천
					</div>
				...
				<div class="store_box">
					<div class="store_box_title">
						<img src="${root}/resources/images/images/3_LIKES.png" height="55">
					</div>
					<div class="stores">
						추천수 기준 리뷰 추천
					</div>
				...
				<div class="store_box">
					<div class="store_box_title">
						<img src="${root}/resources/images/images/4_NEW.png" height="55">
					</div>
					<div class="stores">
						새로 오픈된 스토어 추천
					</div>

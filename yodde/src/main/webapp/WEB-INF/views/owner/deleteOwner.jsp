...
//          alert(check);
         if(check==1){
            ...
            document.location.href="${root}//info/deleteOwner?email='${email}'";
   ...
   <body>
      ...
      <form action="${root}/info/deleteOwner" method="post">
      <div class="content">                           <!-- content -->
         <div class="owdelete_content">
            <div class="owpassword_box" >
               <div class="result_title">               <!-- login title -->
                  <img src="${root}/resources/images/images/passconfirm.png" height="45">
               </div>
               <ul class="owdelete_content_box">
                  <li class="owconfirm_box">
                     <div class="owPassword">
                        Password
                     </div>
               ...
               <input type="hidden" name="email"  value="${email}">
                 ...
                 <li class="owdelete_Btn">
               <button type="submit" style="height:25px; width:75px; border:none; background-image: url(${root}/resources/images/images/ok.png); background-size: 100%;" onclick="javascript:deleteOwner(${check})"></button>

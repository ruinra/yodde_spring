		...
		<div class="content">
			<div class="content_memberJoin">
				<div class="memberJoin_box">
					<form id="valiex" novalidate="novalidate" action="${root}/member/memberJoin" method="post">
						<div class="result_title">				<!-- login title -->
							<img src="${root}/resources/images/images/join_title.png" height="45">
						</div>
						<div class="input_box">
							<p>
								<%-- 
							...
							<p>
								<input type="text" id="zip1" name="zip1" class="join_input_half error" style="ime-mode: active;" readonly>
								<b>-</b> <input type="text" id="zip2" name="zip2" class="join_input_half error" style="ime-mode: active;" readonly>
								<a id="zipcode" name="zipcode" type="button" onclick="openDaumPostcode()">
									<img src="${root}/resources/images/images/zipcode.png" height="23">
								</a>
						...
						<div class="bottom_Btn">
							<input type="IMAGE" src="${root}/resources/images/images/ok.png" height="25" name="Submit" value="Submit">
						<%--                      <a href="${root}/member/memberJoin.do" onclick=""> --%>
						<!--                         <img src="./../images/ok.png" height="30"> -->
						<!--                      </a> -->
						<a href="" onclick="">
						<img src="${root}/resources/images/images/cancel.png" height="25">
						   </a>
						</div>
					</form>
				</div>
